...
function App() {
  ...
  useEffect(() => {
    axios
      .get("http://172.16.12.13:4100//monitor-all/api/v1/monitor2")
      .then((response) => {
    ...
    axios
      .get("http://172.16.12.13:4100//monitor-all/api/v1/HYI")
      .then((response) => {
    ...
    axios
      .get("http://172.16.12.13:4100//monitor-all/api/v1/temp30")
      .then((response) => {
